...
//columns
const columns = [
    { field: 'Invoice', headerName: 'Invoice', width: 170 },
    ...
    { field: 'Amount', headerName: 'Amount', width: 150 },
    {
        ...
        renderCell: (cellvalues) => {
            return (
                ...
                <Button size="small" style={{ backgroundColor: "green", textTransform: 'none', color: "white" }} >paid</Button>)
        }, width: 200
    },
...
//rows
const rows = [
    { id: 1, Invoice: "25423", Client: 'East iceLand', Created: "excepturi", Amount: 'null', job: 'dolor' },
    { id: 2, Invoice: "25423", Client: 'East iceLand', Created: "excepturi", Amount: 'null', job: 'dolor' },
    { id: 3, Invoice: "25423", Client: 'East iceLand', Created: "excepturi", Amount: 'null', job: 'dolor' },
];

//Max height menu
const options = [
    { title: 'Create invoice', route: '' },
    { title: 'Create batch invoice', route: '' },
    { title: 'Send invoice', route: '' },
    { title: 'Setup recurring invoice', route: '' },
    { title: 'Export', route: '' },
];
...
const Invoice = () => {
    ...
    return (
        <div >
            <Typography variant="h5" color="initial" fontWeight={600} style={{ margin: "1rem 0" }}>Your Invoices</Typography>
            <ScrollContainer horizontal={true}>
                <Box className={classes.view_box} style={{ width: '80vw' }}>
                    <Card heading="Due" total='0' percentage="41.3" percentageColor='#05BB3C' />
                    <Card heading="Draft" total='0' percentage="14" percentageColor='#05BB3C' />
                    <Card heading="Over Due" total='0' percentage="9" bgcolor="#131313" color="white" percentageColor='#FF2929' />
                    <Card heading="Paid" total='0' percentage="11" percentageColor='#05BB3C' />
                </Box>
            </ScrollContainer>
            <div  >
                <Grid>
                    <Box
                        ...
                        <Box style={{ display: 'flex', alignItems: 'center', width: '100%', flexWrap: "wrap" }}>
                            ...
                            <div style={{ display: 'flex', gap: "0 1rem", alignItems: "center", flexWrap: "wrap" }}>
                                <Button style={{ backgroundColor: 'rgba(213,7,60,0.3)', textTransform: 'none', color: 'black', padding: '5px 30px', borderRadius: '30px', margin: " .5rem 0" }} onClick={handleClickOpen}>Create Invoice
                                    <img src={Invoice} alt="" style={{ marginLeft: '10px', width: '18px' }} />
                                </Button>
                        ...
                        >
                            ...
                            <DialogActions style={{ margin: 'auto', paddingBottom: '20px' }}>
                                <Button onClick={handleCloseModel} style={{ backgroundColor: 'black', padding: '3px 40px', textTransform: 'none', color: "white" }}>Cancel</Button>
                                <Button onClick={handleCloseModel} autoFocus style={{ backgroundColor: '#D5073C', padding: '3px 40px', textTransform: 'none', color: "white" }}>Create</Button>
                            </DialogActions>
                        </Dialog>
                    </Box>
                </Grid>
