            ...
            <div className="login">
                <div className="loginleft">
                    <div className="loginlefthead">
                        ...
                        <p>Fieldshark helps you schedule jobs, get paid in the field and grow your service business.</p>
                    ...
                    <form className='loginform'>
                        <div style={{ textAlign: "left" }}>
                            ...
                            <TextField label="Email" id="fullWidth" fullWidth />
                            ...
                            <FormControl variant="outlined" fullWidth>
                                ...
                                <OutlinedInput
                                    ...
                                    label="Password"
                                />
                                <FormHelperText id="outlined-weight-helper-text" style={{ color: "black" }}>Forget Password?</FormHelperText>
                            </FormControl> */}
                        </div>
                    </form>
                    ...
                    <NavLink to='/GetStarted' >
                        <Button
                            ...
                            onClick={DataAuth} > Start free trial</Button></NavLink>
